...
if ( ! class_exists( 'WP_Dark_Mode_Admin' ) ) {
	...
	class WP_Dark_Mode_Admin {
		...
		public function handle_review_notice() {
			...
			// Bail if the current value is off.
			...
			$value = ! empty( $_REQUEST['value'] ) ? sanitize_text_field( wp_unslash( $_REQUEST['value'] ) ) : 'hide_notice';
			...
			if ( 'hide_notice' === $value ) {
				...
				delete_transient( 'wp_dark_mode_review_notice_interval' );
		...
		public function handle_affiliate_notice() {
			...
			if ( 'hide_notice' === $value ) {
				...
				delete_transient( 'wp_dark_mode_affiliate_notice_interval' );
		...
		public function display_notices() {
			...
			// Review notice.
			$show_review_notice = 'off' !== get_option( 'wp_dark_mode_review_notice_interval', 'on' ) && 'off' !== get_transient( 'wp_dark_mode_review_notice_interval' );
			...
			// Affiliate notice.
			$show_affiliate_notice = 'off' !== get_option( 'wp_dark_mode_affiliate_notice_interval', 'on' ) && 'off' !== get_transient( 'wp_dark_mode_affiliate_notice_interval' );
