...
<div class="qcformbuilder-config-group">
    ...
    <div class="qcformbuilder-config-field">
        ...
        <p class="description" id="{{_id}}_allowed-desc">
            <?php echo esc_html__('Comma separated eg. jpg,pdf,txt', 'qcformbuilder-forms'); ?>
        </p>
    </div>
</div>
...
<div class="qcformbuilder-config-group">
    ...
    <div class="qcformbuilder-config-field">
        <label for="{{_id}}_use_image_previews"><input id="{{_id}}_use_image_previews" type="checkbox" class="field-config"
            ...
            <?php echo esc_html__('Use image previews', 'qcformbuilder-forms'); ?>
        </label>
    </div>
</div>


<div class="qcformbuilder-config-group" id="{{_id}}_previews_height_wrap">
    <label for="{{_id}}preview_height">
		<?php echo esc_html__('Image Preview Height', 'qcformbuilder-forms'); ?>
    </label>
    <div class="qcformbuilder-config-field">
        <input
...
<div class="qcformbuilder-config-group" id="{{_id}}_previews_width_wrap">
    <label for="{{_id}}preview_width">
		<?php echo esc_html__('Image Preview Width', 'qcformbuilder-forms'); ?>
    </label>
    <div class="qcformbuilder-config-field">
        <input
